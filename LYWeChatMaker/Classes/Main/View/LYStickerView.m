...
- (id)initWithContentView:(UIView *)contentView {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.contentView.center = LYCGRectGetCenter(self.bounds);
        ...
        [self setPosition:LYStickerViewPositionTopLeft forHandler:LYStickerViewHandlerClose];
        [self addSubview:self.closeImageView];
        [self setPosition:LYStickerViewPositionTopRight forHandler:LYStickerViewHandlerRotate];
        [self addSubview:self.rotateImageView];
        [self setPosition:LYStickerViewPositionBottomLeft forHandler:LYStickerViewHandlerFlip];
...
- (void)setImage:(UIImage *)image forHandler:(LYStickerViewHandler)handler {
    switch (handler) {
        case LYStickerViewHandlerClose:
            self.closeImageView.image = image;
            break;
            
        case LYStickerViewHandlerRotate:
            self.rotateImageView.image = image;
            break;
            
        case LYStickerViewHandlerFlip:
...
- (void)setPosition:(LYStickerViewPosition)position forHandler:(LYStickerViewHandler)handler {
    ...
    switch (position) {
        case LYStickerViewPositionTopLeft:
        ...
        case LYStickerViewPositionTopRight:
        ...
        case LYStickerViewPositionBottomLeft:
        ...
        case LYStickerViewPositionBottomRight:
...
- (void)setHandlerSize:(NSInteger)size {
    ...
    [self setPosition:self.closeImageView.tag forHandler:LYStickerViewHandlerClose];
    self.rotateImageView.frame = handlerFrame;
    [self setPosition:self.rotateImageView.tag forHandler:LYStickerViewHandlerRotate];
    self.flipImageView.frame = handlerFrame;
    [self setPosition:self.flipImageView.tag forHandler:LYStickerViewHandlerFlip];
