//
//  LYMakeEmoticonSelectFaceView.m
//  LYWeChatMaker
//
...
@interface LYMakeEmoticonSelectFaceView()
/// 包装选择器
...
@implementation LYMakeEmoticonSelectFaceView

/// 快速创建pickerview方法
+ (instancetype)sharedInstance{
    LYMakeEmoticonSelectFaceView *view = [[LYMakeEmoticonSelectFaceView alloc] init];
    return view;
}
...
- (void)showInViewWithAnimated:(BOOL)animated{
    ...
    CGFloat Y         = SCREEN_HEIGHT - backViewH - kTabbarExtra + topMargin;
